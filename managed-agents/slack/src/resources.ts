...
export const AGENT_ID = process.env.CLAUDE_AGENT_ID || lockfileId("./agents/slack-assistant.md");
export const ENVIRONMENT_ID =
  process.env.CLAUDE_ENVIRONMENT_ID || lockfileId("./environments/slack-assistant.yaml");
