...
def validate_env():
    ...
    if not os.environ.get('ANTHROPIC_API_KEY'):
        ...
        print("  Provide all required environment variables:")
        print("  docker run -e ANTHROPIC_API_KEY=<your-key> \\")
        print("    -e BROWSER_WIDTH=1920 -e BROWSER_HEIGHT=1080 \\")
        print("    -e DISPLAY_WIDTH=1920 -e DISPLAY_HEIGHT=1080 \\")
        print("    -v $(pwd)/browser_use_demo:/home/browseruse/browser_use_demo/ \\")
        print("    -p 5900:5900 -p 8501:8501 -p 6080:6080 -p 8080:8080 \\")
        print("    -it browser-use-demo:latest")
        print("="*60)
        sys.exit(1)
