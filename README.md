...
To use these quickstarts, you'll need an Claude API key.> **Tip:** Most of these projects will look for the `ANTHROPIC_API_KEY` environment variable in your terminal. If you don't have one yet, you can sign up for free at [console.anthropic.com](https://console.anthropic.com).
